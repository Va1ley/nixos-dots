{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
       ...
       monitor = DP-5, 1920x1080@60, auto-left, 1
       monitor = HDMI-A-2, 1920x1080@60, auto-down, 1, transform, 2



       workspace = name:2, monitor:DP-5
       ...
       windowrule = opacity 0.85, match:class dev.zed.Zed

    #   # windowrulev2 = suppressevent maximize, class:.*
       windowrule = opacity 0.98, match:class floorp
       windowrule = opacity 0.8, match:class 'YouTube Music'
